<?php
  ...
  $lastsession = intval(file_get_contents("lastsession.log"),0);
  ...
  if ($currsession % 32 == 0)
  {
    file_put_contents("sessions.log",
  ...
  $writelen = file_put_contents("sessions.log",
  ...
  $writelen = file_put_contents("lastsession.log",
